defmodule Elix.Vacation.Booking do
  use Ecto.Schema
  ...
  schema "bookings" do
    ...
    belongs_to :place, Elix.Vacation.Place
    belongs_to :user, Elix.Accounts.User
  ...
  defp dates_available?(start_date, end_date, place_id) do
    query =
      from booking in Elix.Vacation.Booking,
        where:
  ...
  defp calculate_total_price(changeset) do
    case changeset.valid? do
      true ->
        ...
        place = Elix.Repo.get!(Elix.Vacation.Place, place_id)
